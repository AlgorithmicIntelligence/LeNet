...
if os.path.isfile("./Weights/LeNetWeightsFinal123.pkl"):
    with open("./Weights/LeNetWeightsFinal.pkl", "rb") as f:
...
for epoch in range(epochs):
    ...
    for i in range(len(train_labels)//batch_size):
        ...
        # time_end = time.time()
        if (i % 20) == 0:
            print("Training Data Num ", i*batch_size, "\tlabels = ", train_labels[train_data_index[i*batch_size:(i+1)*batch_size]], "\tlabels_ = ", labels_, "\tLoss = ",loss, "\n")
